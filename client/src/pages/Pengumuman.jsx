...
const Pengumuman = () => {
  ...
  const { user: pengguna, theme } = useSelector((state) => state.auth);
    ...
    <div className='mx-4'>
      <div className="w-full h-fit pb-5">
        <div className="flex items-center justify-between mb-8 my-4 mx-4">
          <Title title="Papan Pengumuman" className={`${theme.darkMode ? 'text-white' : ''} text-lg md:text-2xl`} />
        ...
        <div className={`${theme.darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100'} flex flex-col mx-4 my-2  pt-4 items-center min-h-[90%] h-fit gap-3 rounded-xl`}>
          ...
          <div className="flex flex-col items-center justify-center w-full mb-6">
            <textarea
              ...
              className={`w-[15rem] text-black sm:w-[20rem] placeholder:text-sm sm:placeholder:text-lg px-4 min-h-[100px] h-[250px] text-lg border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 border-black py-2 ${theme.darkMode ? 'bg-transparent text-white border-white' : ''} `}
