...
const Password = ({ open, setOpen, theme }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <ModalWrapper open={open} setOpen={setOpen}>
      <div className="flex flex-col gap-6">
        ...
        <Textbox theme={theme} type={'password'} className={'w-full rounded'} label={'Confirmation'} placeholder={'Masukkan Ulang Password'} register={register('confirmation')} />
